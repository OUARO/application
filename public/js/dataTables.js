$(document).ready(function() {
    $('#ListTable').DataTable({
        ...
        buttons: [
            {
                ...
                titleAttr: 'Exporter',
                filename: document.getElementById('Tablename').innerText,
                title: document.getElementById('Tablename').innerText,
            ...
            },
            {
                ...
                titleAttr: 'Télécharger',
                filename: document.getElementById('Tablename').innerText,
                title: document.getElementById('Tablename').innerText,
                orientation: document.getElementById('print').innerText,
                customize: function (doc) {
                    var f = htmlToPdfmake(" <footer class='d-block bottom-0'><p class='text-center small p-0'><br>&nbsp;Société d'Etat régie par la loi N° 25/99/AN du 16/11/19<br> Créée par décret N° 85/387/CNR/PRES/Eau du 22/07/1985<br> Capital social 3 080 000 000<br><br></p></footer>");
                    doc['footer']= f;
                    doc['styles']={
                        header: {
                        fontSize: 22,
            ...
            {
                text: '<a href="administration/creer',
                filename: document.getElementById('Tablename').innerText,
                title: document.getElementById('Tablename').innerText,
        ...
        search: {
            return: true,
            placeholder: 'Saisir votre recherche et valider'
        },
