    ...
    <div class="card-header">
        <h2 id='Tablename' class="card-title">Liste des candidatures</h2>
        <span hidden id="print">landscape</span>
    </div>
    <div class="card-body">
            <table id="ListTable" class="table table-striped table-sm my-0 display">
                <thead>
                    <tr>
                        ...
                        <th>CNIB</th>
                        <th>N°CNIB/N°PASSPORT</th>
                        <th>Expérience</th>
                        <th>Domaine d'expérience</th>
                        <th>Emploi postulé</th>
                ...
                <tbody>
                    <?php if($candidats==null) : ?> <tr><td> Base vide </td></tr>
                    <?php else : 
                        $i=0; 
                        ...
                        <tr>    
                            ...
                            <td><?= $candidat->date_deliv ?></td> 
                            <td><?= $candidat->num_cnib_passport ?></td>
                            <td><?= $candidat->experience ?></td>
                            <td><?= $candidat->domaine_exp ?></td>
                            <td><?= $candidat->emploi ?></td>
                            <td><?= $candidat->emploi_postule ?></td> 
                            <td><a href="pdf/<?= $candidat->cnib ?>" class="text-dark" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person-badge-fill">
                            ...
                            <td><a href="pdf/<?= $candidat->files ?>" class="text-dark" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-file-pdf-fill">
                                ...
                                </svg><?= $candidat->diplome ?> </a>
                            </td>
                            <td><a href="candidat/<?= $candidat->code ?>" class="text-dark" ><i class='fas fa-eye'></i> </a></td>
                        </tr>
